...
class AustinSymphonyScraper(BaseScraper):
    ...
    def get_data_schema(self) -> Dict:
        ...
        return {
            ...
            'featured_artist': {'type': 'string', 'required': False, 'description': 'Featured artist or soloist'},
            ...
            'time': {'type': 'string', 'required': True, 'description': 'Event time (e.g., "8:00 PM")'},
        ...
        try:
            ...
            for event in symphony_events:
                ...
                for i, date in enumerate(dates):
                    time = times[i] if i < len(times) else times[0] if times else "8:00 PM"
