...
class HyperrealScraper(BaseScraper):
    ...
    def _extract_event_data_from_page(self, html_content: str, url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            start_time = start_time_elem.get_text(strip=True) if start_time_elem else None
        ...
        try:
            ...
            for event_url in event_links:
                try:
                    ...
                    # Extract event data
                    event_data = self._extract_event_data_from_page(event_html, event_url)
                    if event_data:
