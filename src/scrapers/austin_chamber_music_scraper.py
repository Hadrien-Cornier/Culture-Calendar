"""
Austin Chamber Music Festival scraper using JSON data loading
"""
...
class AustinChamberMusicScraper(BaseScraper):
    """Simple scraper for Austin Chamber Music Festival events - loads from JSON data"""

    def __init__(self):
        super().__init__(base_url="https://austinchambermusic.org", venue_name="Chamber Music")
        self.data_file = (
    ...
    def get_data_schema(self) -> Dict:
        ...
        return {
            ...
            "program": {
                "type": "string",
                "required": False,
                "description": "Concert program description",
            },
            "featured_artist": {
                "type": "string",
                "required": False,
    ...
    def scrape_events(self, use_cache: bool = True) -> List[Dict]:
        ...
        try:
            ...
            chamber_music_events = data.get("austinChamberMusic", [])
            standardized_events = []
            ...
            for event in chamber_music_events:
                ...
                for i, date in enumerate(dates):
                    ...
                    standardized_event = {
                        ...
                        "location": event.get("venue_name", "Austin Chamber Music Center"),
                        "type": "concert",
                        "url": self.base_url,
                    }
                    standardized_events.append(standardized_event)

            print(f"Loaded {len(standardized_events)} Chamber Music events from JSON")
            return standardized_events

        except Exception as e:
            print(f"Error loading Chamber Music events from JSON: {e}")
            return []