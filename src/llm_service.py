...
class LLMService:
    ...
    def __init__(self):
        ...
        if not self.anthropic:
            print("Warning: ANTHROPIC_API_KEY not found. LLM features will be disabled.")
    
    def extract_data(self, content: str, schema: Dict, url: str = "", content_type: str = "html") -> Dict:
        """
    ...
    def validate_extraction(self, extracted_data: Dict, schema: Dict, original_content: str = "") -> Dict:
        """
        ...
        """
        if not self.anthropic:
            return {"is_valid": True, "confidence": 0.5, "reason": "LLM validation not available"}
        ...
        try:
            ...
            error_result = {"is_valid": False, "confidence": 0.0, "reason": f"Validation error: {str(e)}"}
...
"""
    ...
    def _create_extraction_prompt(self, content: str, schema: Dict, content_type: str) -> str:
...
"""
    ...
    def _create_validation_prompt(self, extracted_data: Dict, schema: Dict, original_content: str) -> str:
...
VALIDATION CRITERIA:
1. Are the dates realistic and in the future (or recent past)?
