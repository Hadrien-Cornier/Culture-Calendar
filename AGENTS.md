...
This project is indexed by GitNexus as **Culture-Calendar** (3884 symbols, 9168 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
